...
const FreeKassaWidget = ({ isOpen, onClose, amount }: FreeKassaWidgetProps) => {
  ...
  const widgetUrl = `https://widgets.freekassa.net?type=payment-window&lang=ru&theme=dark&default_amount=${Math.round(amount)}&api_key=5f010c41730c3462cc8eacca8a42b6e2&shopID=76166`;
