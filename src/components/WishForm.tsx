    ...
    <section className="flex flex-col items-center justify-center min-h-screen px-4" aria-labelledby="main-heading">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="space-y-6 animate-fade-in">
          <p id="wish-description" className="text-lg text-gray-600 mb-8">После "ОК" - выбирайте силу вашего желания, Дополнительно документ Аффирмации будет отправлен на почту или  WhatsApp</p>
          ...
          <div className="max-w-lg mx-auto space-y-4">
            <Textarea
              ...
              className="min-h-[120px] text-lg border-2 border-indigo-600 focus:border-indigo-700 transition-colors"
