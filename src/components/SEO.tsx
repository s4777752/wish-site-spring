...
const SEO = ({ 
  title = "Сайт Желаний — загадать желание онлайн и получить документ аффирмации",
  description = "Загадайте желание онлайн: укажите силу намерения, сделайте энергетический вклад и получите персональный документ аффирмации. Метод основан на принципах позитивной психологии.",
  keywords = "загадать желание, исполнение желаний, желания онлайн, сайт желаний, энергетический вклад, документ аффирмации, исполнить мечту",
  ogImage = "https://wish-site-spring.poehali.dev/img/og-star.png",
